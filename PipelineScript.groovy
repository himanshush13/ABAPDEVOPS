              ...
              parallel{
                    stage('ATC Checks HANA Readiness - FUNCTIONAL_DB'){
                     ...
                     stage('ATC Checks HANA Readiness - FUNCTIONAL_DB_ADDITION'){
                           ...
                           withCredentials([[$class: 'UsernamePasswordMultiBinding', credentialsId: 'NID', usernameVariable: 'USERNAME', passwordVariable: 'PASSWORD']]) {
                            sh ''' 
                           docker run -t postman/newman run https://github.com/mygit999/ABAPDevOps.git/ABAPDEVOPS/master/03_ATC_Checks/abap_atc.postman_collection.json -k --bail --environment https://github.com/mygit999/ABAPDevOps.git/ABAPDEVOPS/master/03_ATC_Checks/abap_atc_funcdbadd.postman_environment.json --timeout-request 120000 --global-var "username=$USERNAME" --global-var "password=$PASSWORD" --global-var "package=ZDEVOPS"
                           '''
                           }
                        }
                     }
